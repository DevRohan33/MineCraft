...
window.fps_counter.enabled = True  # Disable the FPS Counter
window.exit_button.visible = True  # Remove the default exit (close) Button
...
sky = Sky()
hand = Hand()
exit_button = ExitButton()  # Create an instance of the ExitButton class
